...
<div class="container">
  ...
  <div class="container-fluid">
	...
	<a href="mailto:email@email.com?Subject=CPE Info Update - Remote 1" class="btn btn-default btn-lg btnFix">
	...
	<!-- end menu php -->
			...
			<div class="row bottom-padding5 topPadding10">
				<div class="col-lg-8 col-md-8 col-sm-12 topPadding5">
					<span class="orangePBI">Remote</span> <span class="bluePLI"> 1</span>
				</div>
			</div>
